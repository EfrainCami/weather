...
const emit = defineEmits(["hoursWithTemperatures"]);
...
onUpdated(() => {
  ...
  if (clicked) {
    emit("hoursWithTemperatures", [props.hours, props.temperatures]);
  }
});
</script>
